...
srun(["rm", "Dockerfile", "LICENSE", "README.md", "add_to_team_drive.py", "app.json", "captain-definition", "config_sample.env", "gen_sa_accounts.py", "generate_drive_token.py", "generate_string_session.py", "heroku.yml", "requirements-cli.txt", "requirements.txt"])
